...
// AdminListFilter Adminユーザー検索用構造体
type AdminListFilter struct {
	SearchWord string
}

// AdminUseCase Adminユーザーの認証処理およびアカウント管理のビジネスロジックを担当するユースケース
...
// =========================================================================
// 🛠️ Admin Management CRUD (Adminユーザーロジック) - ルーティングのガード内側で利用
// =========================================================================
...
// CreateAdmin 重複チェックとパスワードのハッシュ化を行い、新しいAdminユーザーを作成する
...
func (u *AdminUseCase) GetAdminsWithPagination(
	...
	return usecase.ExecutePaginatedSearch(
		...
		u.adminRepo.CountAll,
		u.adminRepo.FindAllWithPagination,
	)
}
...
// UpdateAdmin 既存のAdminユーザー情報を更新する（パスワードが空文字の場合は変更なしとして扱う）
...
// DeleteAdmin AdminユーザーIDを指定して、該当するAdminユーザーアカウントを削除する
