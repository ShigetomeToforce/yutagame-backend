...
type Game struct {
	...
	SurugayaID         *string   `gorm:"column:surugaya_id;type:varchar(64)" json:"surugayaId,omitempty"`
	ReferenceUsedPrice *int32    `gorm:"column:reference_used_price" json:"referenceUsedPrice,omitempty"`
	ReferenceBuyPrice  *int32    `gorm:"column:reference_buy_price" json:"referenceBuyPrice,omitempty"`
