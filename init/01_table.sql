...
CREATE TABLE `manufacturers` (
    ...
    `image_key` VARCHAR(255) NULL COMMENT '画像キー' COLLATE 'utf8mb4_0900_ai_ci',
...
CREATE TABLE `games` (
    ...
    `surugaya_id` varchar(64) DEFAULT NULL,
    `reference_used_price` int DEFAULT NULL,
    `reference_buy_price` int DEFAULT NULL,
    `release_date` DATE NOT NULL COMMENT '発売日',
