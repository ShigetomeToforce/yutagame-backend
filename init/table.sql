...
CREATE TABLE `game` (
	...
	`keyword_codes` VARCHAR(1024) NOT NULL COMMENT 'キーワード' COLLATE 'utf8mb4_0900_ai_ci',
	...
	`amazon_affiliate_url` VARCHAR(256) NOT NULL COMMENT 'アマゾンアフィリエイトURL' COLLATE 'utf8mb4_0900_ai_ci',
	`rakuten_affiliate_url` VARCHAR(256) NOT NULL COMMENT '楽天アフィリエイトURL' COLLATE 'utf8mb4_0900_ai_ci',
	`surugaya_affiliate_url` VARCHAR(256) NOT NULL COMMENT '駿河屋アフィリエイトURL' COLLATE 'utf8mb4_0900_ai_ci',
	`surugaya_image_url_small` VARCHAR(128) NOT NULL COMMENT '駿河屋画像URL（S）' COLLATE 'utf8mb4_0900_ai_ci',
	`surugaya_image_url_middle` VARCHAR(128) NOT NULL COMMENT '駿河屋画像URL（M）' COLLATE 'utf8mb4_0900_ai_ci',
	`surugaya_image_url_large` VARCHAR(128) NOT NULL COMMENT '駿河屋画像URL（L）' COLLATE 'utf8mb4_0900_ai_ci',
...
CREATE TABLE `genre` (
	...
	`overview` VARCHAR(2000) NOT NULL COMMENT '概要' COLLATE 'utf8mb4_0900_ai_ci',
	`code` VARCHAR(30) NOT NULL COMMENT 'コード' COLLATE 'utf8mb4_0900_ai_ci',
	`surugaya_image_url_small` VARCHAR(128) NOT NULL COMMENT '駿河屋画像URL(小)' COLLATE 'utf8mb4_0900_ai_ci',
	`surugaya_image_url_middle` VARCHAR(128) NOT NULL COMMENT '駿河屋画像URL(中)' COLLATE 'utf8mb4_0900_ai_ci',
	`surugaya_image_url_large` VARCHAR(128) NOT NULL COMMENT '駿河屋画像URL(大)' COLLATE 'utf8mb4_0900_ai_ci',
	`created_at` DATETIME NOT NULL COMMENT '登録日',
	`updated_at` DATETIME NOT NULL COMMENT '更新日',
	PRIMARY KEY (`id`) USING BTREE,
	UNIQUE INDEX `code` (`code`) USING BTREE
